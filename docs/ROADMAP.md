...
- [x] Physical-build measurement kit: `measurements.csv` template +
      `scripts/check_measurements.py` validator (auto-check vs ideal, fits
      `dVout/dx1`); real readings still pending hardware
