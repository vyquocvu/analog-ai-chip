...
Run `python book/0001-crossbar-mvm/train.py`. The assertions are the contract between this arithmetic and the implementation.

## Break it deliberately

Change one conductance to a negative value. The program rejects it because a physical conductance is non-negative. Chapter 0002 shows how two arrays represent signed neural-network weights without inventing negative conductance.
