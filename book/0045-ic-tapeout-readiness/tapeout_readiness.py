...
def build_pdk_requirements() -> list[PDKRequirement]:
    ...
    return [
        ...
        PDKRequirement(
            ...
            requirement_name="Crossbar Array Pitch and Density",
        ...
        PDKRequirement(
            ...
            requirement_name="SAR ADC and TIA Headroom",
        ...
        PDKRequirement(
            ...
            requirement_name="DRC / LVS and Parasitic Extraction",
...
def build_open_risk_matrix() -> list[OpenRiskItem]:
    ...
    return [
        OpenRiskItem(
            risk_id="RISK-01",
            risk_title="Memristor Cycle-to-Cycle and Device-to-Device Variation",
            severity="HIGH",
            probability="MEDIUM",
        ...
        OpenRiskItem(
            risk_id="RISK-03",
            risk_title="Array Line Resistance and IR Drop Degradation",
            severity="MEDIUM",
            probability="LOW",
        ...
        OpenRiskItem(
            risk_id="RISK-05",
            risk_title="ADC Area and Power Scaling in 28nm",
            severity="MEDIUM",
            probability="MEDIUM",
...
def build_tapeout_readiness_checks() -> list[TapeoutGateCheck]:
    ...
    return [
        TapeoutGateCheck(
            gate_name="Mathematical and Algorithm Parity",
        ...
        TapeoutGateCheck(
            gate_name="Circuit SPICE and Device Non-idealities",
        ...
        TapeoutGateCheck(
            gate_name="Digital Control and Hardware Shell",
            domain="Digital Control",
            current_status="PASS",
            pass_criteria="Cycle-accurate digital shell executing FSM scheduler, double-buffered SRAM, and accumulators",
            current_evidence="Ch. 0043: Executable digital shell matches Ch. 0038 timing model to &lt; 1% delta",
            ready_for_fab=True,
        ),
        TapeoutGateCheck(
            gate_name="Hardware Testbench and PCB Correlation",
